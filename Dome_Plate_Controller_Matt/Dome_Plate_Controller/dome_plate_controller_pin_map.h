...
#define SERIAL_TX_US	            18 //  // Unused Pin
#define SERIAL_RX_US      19 //  // ESP32 Status NeoPixel Pin
...
#define SERIAL1_RX_PIN       25 //  // Pin connected to the relay output
#define UP_26	        26 //  // Unused Pin
#define SERIAL1_TX_PIN	        27 //  // Unused Pin
