...
function findWasmBinary() {
  return locateFile('X18_FCC.wasm');
}
...
var ASM_CONSTS = {
  5797872: () => { FS.syncfs(false, function (err) { ccall('onSyncFsDone', 'void', [], []); if (err) { console.error("Sync to IndexedDB failed:", err) } else if (Module.syncToLocal) { Module.syncToLocal() } }) },  
 5798067: ($0) => { Module.setSwitchesConfig && Module.setSwitchesConfig($0) },  
 5798128: ($0, $1) => { Module.setSwitchesPosition && Module.setSwitchesPosition($0, $1) },  
 5798197: ($0, $1) => { Module.setFunctionSwitchesState && Module.setFunctionSwitchesState($0, $1) },  
 5798276: ($0, $1) => { Module.setTrimsValue && Module.setTrimsValue($0, $1) },  
 5798333: ($0, $1) => { Module.audioPushBuffer && Module.audioPushBuffer($0, $1) },  
 5798394: ($0, $1, $2) => { Module.updateCanvas && Module.updateCanvas($0, $1, $2) }
};
...
if (typeof exports === 'object' && typeof module === 'object') {
  module.exports = X18_FCC;
  // This default export looks redundant, but it allows TS to import this
  // commonjs style module.
  module.exports.default = X18_FCC;
