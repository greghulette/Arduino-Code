...
function findWasmBinary() {
  return locateFile('X20RS_FCC.wasm');
}
...
var ASM_CONSTS = {
  8491744: () => { FS.syncfs(false, function (err) { ccall('onSyncFsDone', 'void', [], []); if (err) { console.error("Sync to IndexedDB failed:", err) } else if (Module.syncToLocal) { Module.syncToLocal() } }) },  
 8491939: ($0) => { Module.setExtPotsEnable && Module.setExtPotsEnable($0) },  
 8491998: ($0) => { Module.setSwitchesConfig && Module.setSwitchesConfig($0) },  
 8492059: ($0, $1) => { Module.setSwitchesPosition && Module.setSwitchesPosition($0, $1) },  
 8492128: ($0, $1) => { Module.setFunctionSwitchesState && Module.setFunctionSwitchesState($0, $1) },  
 8492207: ($0, $1) => { Module.setTrimsValue && Module.setTrimsValue($0, $1) },  
 8492264: ($0, $1) => { Module.audioPushBuffer && Module.audioPushBuffer($0, $1) },  
 8492325: ($0, $1, $2) => { Module.updateCanvas && Module.updateCanvas($0, $1, $2) }
};
...
if (typeof exports === 'object' && typeof module === 'object') {
  module.exports = X20RS_FCC;
  // This default export looks redundant, but it allows TS to import this
  // commonjs style module.
  module.exports.default = X20RS_FCC;
