...
#define LIFTER_SEEKBOTTTOM_POWER    20      // 40 out of 100. Lower than LIFTER_MINIMUM_POWER because we are going down
#define ROTARY_MINIMUM_POWER        30      // 40 out of 100. Don't bother with lower values. Won't rotate reliably
#define LIFTER_DISTANCE             450     // default value 1200 - lifter will calibrate

#define ROTARY_MINIMUM_HEIGHT       LIFTER_DISTANCE*.7
