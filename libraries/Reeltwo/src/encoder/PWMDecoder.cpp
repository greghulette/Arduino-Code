...
// ESP-IDF v5+ completely revamped the RMT driver; legacy direct register
// access (RMTMEM, RMT struct) is no longer available.  PWMDecoder's ISR
// path is therefore stubbed out.  Use RMT_RX_MODE or SBUS instead.
void IRAM_ATTR PWMDecoder::rmt_isr_handler(void* /*arg*/) {}
void PWMDecoder::checkActive(unsigned /*i*/) {}
void PWMDecoder::begin(void) {}
void PWMDecoder::end(void) {}
#else
