...
const uint8_t umac_oct2 = 0xDA;     // unique MAC address for the 2nd Octet; my initials of course
const uint8_t umac_oct3 = 0x49;     // unique MAC address for the 3rd Octet; the average of 52 78 2D 44 34, which is hex code for Rx-D4
