...
void processStoredCommands(String storedC){
  ...
  char *p = buf;
  char *str;
  while ((str = strtok_r(p, STORED_COMMAND_DELIMITER, &p)) !=NULL){
    sC = String(str);
    ESPNOWBroadcastCommand = false;
    queue.push(sC);
  };
        ...
        if (
            ...
            if (inputBuffer[1]=='D' || inputBuffer[1]=='d'){
              ...
              serialPort = "";
                ...
                } else if (tempStoredCommands == "PRINT"){
        ...
        if( inputBuffer[1]=='W' ||        // Command for Sending ESP-NOW Messages
          ...
          if(commandLength >= 3) {
            ...
            if(inputBuffer[1]=='S' || inputBuffer[1]=='s') {
              ...
              // String tempStoredCommandsFunctionSubString = tempStoredCommandsFunction.substring(2,commandLength+1);
