...
///*****                                                                  *****///
//////////////////////////////////////////////////////////////////////////////////
const byte LEDpins[HPCOUNT]   = {25,18,16};   // {Front, Rear, Top}
...
#define STATUSLEDPIN 4                    // The builtin LED on the Arduino mini is on pin 13
...
void setup() { 
  Serial.begin(115200);                      // Starts Serial with a baudrate of 9600
  inputString.reserve(10);                 // reserve 10 bytes for the inputString

  Wire.begin();                  // Connects to I2C Bus and establishes address.
