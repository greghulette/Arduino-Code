...
///////////////////////////////////////////////////////////////////////
  ...
  String RELAY_STATUS_STRING;
// int lastButtonState = 0;  // the previous reading from the input pin

// unsigned long lastDebounceTime = 0;  // the last time the output pin was toggled
// unsigned long debounceDelay = 50;    // the debounce time; increase if the output flickers

  Toggle button(RELAY_BUTTON);
...
void displayOLEDString(String StringtoDisplay){
   display.clear();
    ...
    display.drawString(68,0,"Gateway");
    display.setFont(ArialMT_Plain_10);
    display.setTextAlignment(TEXT_ALIGN_LEFT);
    display.drawString(0, 20, "RELAY STATUS: ");
    display.drawString(90, 20, RELAY_STATUS_STRING);
